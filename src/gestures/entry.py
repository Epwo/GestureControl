...
def detect_victory_gesture(self:"GestureDetection", closed_fingers, is_base_hand_moving, landmarks):
    """
    ...
    if is_victory and not is_base_hand_moving and not self.close_recent_action:
